...
class _LeadScreen extends State<LeadScreen> {
  ...
  List<String> listFunction = [
    "CRM",
    AppLocalizations.text(LangKey.useExcel) ?? "Dùng excel",
    AppLocalizations.text(LangKey.timekeeping) ?? "Chấm công",
    "Chathub",
    AppLocalizations.text(LangKey.jobManagement) ?? "Quản lý công việc",
    AppLocalizations.text(LangKey.timekeeping) ?? "Chấm công",
    "QLCV"
  ];
            ...
            child: StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                return ContainerDataBuilder(
                  ...
                  emptyBuilder: CustomDataNotFound(),
                  onRefresh: () async {
                    filterModel!.page = 1;
                    getData(false);
                  },
